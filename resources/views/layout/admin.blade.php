...
<html lang="en">
	...
	<head>
		<meta charset="utf-8" />
		<title>UOS Attendence System | @yield('title')</title>
					...
					<div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
						...
						<div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
							...
							<ul class="menu-nav">
								...
								<li class="menu-item {{Request::is('student/create')?'menu-item-active':''}}" aria-haspopup="true">
                                ...
                                <li class="menu-item {{Request::is('student')?'menu-item-active':''}}" aria-haspopup="true">
                                ...
                                <li class="menu-item {{Request::is('attendence/index')?'menu-item-active':''}}" aria-haspopup="true">
